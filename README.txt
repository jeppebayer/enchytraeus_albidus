...
BUSCO analysis has been done using the matazoa database (this may be too wide a database)

8k_q20 purge-dupped thrice has been chosen as the best option for a reference genome.