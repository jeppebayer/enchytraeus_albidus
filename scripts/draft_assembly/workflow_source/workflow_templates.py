...
def hifiadapterfilt(pacbio_hifi_file: str, output_directory: str, hifiadapterfilt_directory: str = f'{os.path.dirname(os.path.realpath(__file__))}/software/HiFiAdapterFilt'):
	...
	:param
	"""
	os.makedirs(f'{output_directory}/HiFiAdapterFilt', exist_ok=True)
	working_dir = f'{output_directory}/HiFiAdapterFilt'
	...
	outputs = {'filt': f'{output_directory}/HiFiAdapterFilt/{prefix}.filt.fastq.gz',
               'cont': f'{output_directory}/HiFiAdapterFilt/{prefix}.contaminant.blastout',
               'block': f'{output_directory}/HiFiAdapterFilt/{prefix}.blocklist',
               'stats': f'{output_directory}/HiFiAdapterFilt/{prefix}.stats'}
	...
	cp {pacbio_hifi_file} {output_directory}/HiFiAdapterFilt/prog{ext}
    ...
    rm {output_directory}/HiFiAdapterFilt/prog{ext}
